...
class DiyaCard extends StatefulWidget {
  const DiyaCard({Key? key}) : super(key: key);

  @override
  State<DiyaCard> createState() => _DiyaCardState();
}

class _DiyaCardState extends State<DiyaCard> {
  ...
  Widget buildProfileImage() => CircleAvatar(
        ...
        backgroundImage: const AssetImage('assets/images/profile/diya.png'),
      );
}
