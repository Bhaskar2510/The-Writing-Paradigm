...
class BhavnaCard extends StatefulWidget {
  const BhavnaCard({Key? key}) : super(key: key);

  @override
  State<BhavnaCard> createState() => _BhavnaCardState();
}

class _BhavnaCardState extends State<BhavnaCard> {
  ...
  Widget buildProfileImage() => CircleAvatar(
        ...
        backgroundImage: const AssetImage('assets/images/profile/bhavna.png'),
      );
}
