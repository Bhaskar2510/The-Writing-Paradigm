...
class VaniCard extends StatefulWidget {
  const VaniCard({Key? key}) : super(key: key);

  @override
  State<VaniCard> createState() => _VaniCardState();
}

class _VaniCardState extends State<VaniCard> {
  ...
  Widget buildProfileImage() => CircleAvatar(
        ...
        backgroundImage: const AssetImage('assets/images/profile/vani.png'),
      );
}
