...
class ArushiCard extends StatefulWidget {
  const ArushiCard({Key? key}) : super(key: key);

  @override
  State<ArushiCard> createState() => _ArushiCardState();
}

class _ArushiCardState extends State<ArushiCard> {
  ...
  Widget buildProfileImage() => CircleAvatar(
        ...
        backgroundImage: const AssetImage('assets/images/profile/arushi.png'),
      );
}
