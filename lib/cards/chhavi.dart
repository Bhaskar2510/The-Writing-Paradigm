...
class ChhaviCard extends StatefulWidget {
  const ChhaviCard({Key? key}) : super(key: key);

  @override
  State<ChhaviCard> createState() => _ChhaviCardState();
}

class _ChhaviCardState extends State<ChhaviCard> {
  ...
  Widget buildProfileImage() => CircleAvatar(
        ...
        backgroundImage: const AssetImage('assets/images/profile/chhavi.png'),
      );
}
