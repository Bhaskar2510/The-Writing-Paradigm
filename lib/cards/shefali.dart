...
class ShefaliCard extends StatefulWidget {
  const ShefaliCard({Key? key}) : super(key: key);

  @override
  State<ShefaliCard> createState() => _ShefaliCardState();
}

class _ShefaliCardState extends State<ShefaliCard> {
  ...
  Widget buildProfileImage() => CircleAvatar(
        ...
        backgroundImage: const AssetImage('assets/images/profile/shefali.png'),
      );
}
