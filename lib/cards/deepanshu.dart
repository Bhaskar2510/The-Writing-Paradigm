...
class DeepanshuCard extends StatefulWidget {
  const DeepanshuCard({Key? key}) : super(key: key);

  @override
  State<DeepanshuCard> createState() => _DeepanshuCardState();
}

class _DeepanshuCardState extends State<DeepanshuCard> {
  ...
  Widget buildProfileImage() => CircleAvatar(
        ...
        backgroundImage: const AssetImage('assets/images/profile/deepanshu.png'),
      );
}
        ...
        Row(
          ...
          children: [
            buildSocialIcon(
              ...
              Uri.parse('https://www.facebook.com/gujjar.samrat.singh.ambavat'),
            ),
            const SizedBox(
              width: 16.0,
            ),
