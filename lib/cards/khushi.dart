...
class KhushiCard extends StatefulWidget {
  const KhushiCard({Key? key}) : super(key: key);

  @override
  State<KhushiCard> createState() => _KhushiCardState();
}

class _KhushiCardState extends State<KhushiCard> {
  ...
  Widget buildProfileImage() => CircleAvatar(
        ...
        backgroundImage: const AssetImage('assets/images/profile/khushi.png'),
      );
}
